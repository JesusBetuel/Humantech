...
$(function () {
    ...
    setTimeout(function () { $('#pageLoaderWrapper').fadeOut(); }, 50);

    $.validator.addMethod("phoneNumber", function (phone_number, element) {
        phone_number = phone_number.replace(/\s+/g, "");
        return this.optional(element) || phone_number.length > 9 && phone_number.match(/^(\+?1-?)?(\([2-9]\d{2}\)|[2-9]\d{2})-?[2-9]\d{2}-?\d{4}$/);
    }, "Por favor especifica un teléfono valido");
    ...
    jQuery.extend(jQuery.validator.messages, {
        ...
        remote: "Por favor arregla este dato.",
        email: "Por favor, introduce una dirección de correo electrónico valida.",
        url: "Por favor introduzca un URL valido.",
        date: "Por favor introduzca una fecha valida.",
        dateISO: "Por favor, introduzca una fecha vallida (ISO).",
        number: "Por favor ingrese un número valido.",
        digits: "Por favor ingrese solo digitos.",
        creditcard: "Favor de introducir una numero de tarjeta valido.",
